...
export class Message extends ClassEvent {
  ...
  getViewElement(me = true) {
        ...
        messageEl.innerHTML = `
          <div class="font-style _3DFk6 tail" id="_${this._id}">
              ...
              <div class="Tkt2p">
                  ...
                  <div class="_2f-RV">
                      <div class="_1DZAH">
                          <span class="message-time">${this._createdAt.toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })}</span>
                      </div>
                  </div>
              </div>
          </div>
    ...
    let messageDirectionClass = 'message-in';

    if (me) {
        messageDirectionClass = 'message-out';
        messageEl.querySelector('.message-time').parentElement.appendChild(this.getStatusViewElement());
    }

    messageEl.firstElementChild.classList.add(messageDirectionClass);
